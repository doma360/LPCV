...
import { createHandler, listForProfessionnelHandler, listMesAvisHandler, signalerHandler } from "./avis.controller.js";
...
avisRouter.get("/mes-avis", requireAuth, asyncHandler(listMesAvisHandler));
